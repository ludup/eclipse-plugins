...
public enum TemplateAssignableResourcePermission implements PermissionType {
	...
	private TemplateAssignableResourcePermission(final String val, PermissionType... implies) {
		this.val = name + "." + val;
